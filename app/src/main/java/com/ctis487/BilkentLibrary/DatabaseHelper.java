...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static String DATABASE_NAME="albumDB";
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        Log.d("DATABASE OPERATIONS","OnCreate, table created"+ BookDB.CREATE_TABLE_SQL);

        try {
            sqLiteDatabase.execSQL(BookDB.CREATE_TABLE_SQL);
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int oldVersion, int newVersion) {
        ...
        try {
            sqLiteDatabase.execSQL(BookDB.DROP_TABLE_SQL);
    ...
    public Cursor getAllRecordsMethod2(String sql , String...where){
        Cursor cursor = db.rawQuery("select * from "+ BookDB.TABLE_NAME,where);
        Log.d("DATABASE OPERATIONS", "GET THE RECORDS");
